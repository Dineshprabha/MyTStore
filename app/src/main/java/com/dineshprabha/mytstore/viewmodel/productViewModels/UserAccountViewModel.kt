...
import com.dineshprabha.mytstore.MyTstoreApplication
...
class UserAccountViewModel @Inject constructor(
    ...
    private fun saveUserInformationWithNewImage(user: User, imageUri: Uri) {
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(getApplication<MyTstoreApplication>().contentResolver, imageUri)
